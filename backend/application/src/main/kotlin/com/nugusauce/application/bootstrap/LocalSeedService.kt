...
class LocalSeedService(
    ...
    companion object {
        ...
        private val INGREDIENT_SEEDS = listOf(
            ...
            IngredientSeed("땅콩소스", "sauce"),
            IngredientSeed("다진 마늘", "aromatic"),
            IngredientSeed("고수", "herb"),
            IngredientSeed("다진 고추", "spicy"),
            IngredientSeed("해선장", "sauce"),
            IngredientSeed("간장", "sauce"),
            IngredientSeed("식초", "acid"),
            IngredientSeed("설탕", "sweetener"),
            IngredientSeed("파", "aromatic"),
            IngredientSeed("깨", "topping"),
            IngredientSeed("고추기름", "spicy"),
            IngredientSeed("스위트 칠리소스", "sauce"),
            IngredientSeed("땅콩가루", "topping"),
            IngredientSeed("고춧가루", "spicy"),
            IngredientSeed("볶음 소고기장", "umami"),
            IngredientSeed("마라소스", "spicy"),
            IngredientSeed("참깨소스", "sauce"),
            IngredientSeed("굴소스", "sauce"),
            IngredientSeed("중국식초", "acid"),
            IngredientSeed("흑식초", "acid"),
            IngredientSeed("와사비", "pungent"),
            IngredientSeed("레몬즙", "acid"),
            IngredientSeed("소금", "seasoning"),
            IngredientSeed("맛소금", "seasoning"),
            IngredientSeed("연유", "sweetener"),
            IngredientSeed("들깨가루", "topping"),
            IngredientSeed("양파", "aromatic"),
            IngredientSeed("태국 고추", "spicy"),
            IngredientSeed("다진 고기", "umami"),
            IngredientSeed("마라시즈닝", "spicy"),
            IngredientSeed("청유 훠궈 소스", "spicy"),
            IngredientSeed("버섯소스", "sauce"),
            IngredientSeed("오향 우육", "umami"),
            IngredientSeed("매운 소고기 소스", "spicy"),
            IngredientSeed("쪽파", "aromatic"),
            IngredientSeed("대파", "aromatic"),
            IngredientSeed("참깨가루", "topping")
        )
