...
enum class ErrorCode(
    ...
    INVALID_APPLE_TOKEN("AUTH_014", "error.invalid_apple_token", 401),
    APPLE_NONCE_MISMATCH("AUTH_015", "error.apple_nonce_mismatch", 401),
    APPLE_VERIFIED_EMAIL_REQUIRED("AUTH_016", "error.apple_verified_email_required", 422),
